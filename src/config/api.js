...
export const API_CONFIG = {
  ...
  NEW_BASE_URL: process.env.REACT_APP_API_URL || "http://localhost:5000/api/v1",
  
  // Feature flag to toggle between old and new API
  USE_NEW_API: process.env.REACT_APP_USE_NEW_API === "true",
...
export const getEndpoint = (category, endpoint) => {
  ...
  const path = useNew ? ENDPOINTS[category][endpoint].NEW : ENDPOINTS[category][endpoint].OLD;
